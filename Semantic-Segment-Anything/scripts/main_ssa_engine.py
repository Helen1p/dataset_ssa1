...
def parse_args():
    ...
    # parser.add_argument('--data_dir', default='/root/autodl-tmp/DIV2K_train_HR', help='specify the root path of images and masks')
    parser.add_argument('--out_dir_json', default='/root/autodl-tmp/json/', help='the dir to save semantic annotations')
    parser.add_argument('--out_dir_semantic', default='/root/autodl-tmp/semantic/', help='the dir to save semantic annotations')
    parser.add_argument('--out_dir_dis', default='/root/autodl-tmp/DIV2K_output/', help='the dir to save semantic annotations')
...
def main(rank, args):
    ...
    # 半路挂了
    # have_done = os.listdir('/root/autodl-tmp/DIV2K_output/')
    # have_all = os.listdir('/root/autodl-tmp/DIV2K_train_HR')
    # local_filenames = list(set(have_all)-set(have_done))
    # local_filenames = [x.split('.')[0] for x in local_filenames]
